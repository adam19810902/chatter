...
const userGordon = DemoUser(
  ...
  name: 'Gordon Hayes',
  image:
  'https://picsum.photos/seed/100/300/300',
...
const userSalvatore = DemoUser(
  ...
  image:
  'https://picsum.photos/seed/101/300/300',
...
const userSacha = DemoUser(
  ...
  name: 'Sacha Arbonel',
  image:
  'https://picsum.photos/seed/102/300/300',
...
const userDeven = DemoUser(
  ...
  name: 'Deven Joshi',
  image:
  'https://picsum.photos/seed/103/300/300',
...
const userSahil = DemoUser(
  ...
  name: 'Sahil Kumar',
  image:
  'https://picsum.photos/seed/104/300/300',
...
const userReuben = DemoUser(
  ...
  name: 'Reuben Turner',
  image:
  'https://picsum.photos/seed/105/300/300',
...
const userNash = DemoUser(
  ...
  name: 'Nash Ramdial',
  image:
  'https://picsum.photos/seed/106/300/300',
